fileprivate let parsers: [Int32 : (BufferReader) -> Any?] = {
    ...
    dict[-1586283796] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionSetMessageTTL($0) }
    dict[206520510] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionReadMessages($0) }
    dict[1700872964] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionDeleteMessages($0) }
    dict[-1967000459] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionScreenshotMessages($0) }
    dict[1729750108] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionFlushHistory($0) }
    dict[-217806717] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionNotifyLayer($0) }
    dict[1360072880] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionResend($0) }
    dict[-204906213] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionRequestKey($0) }
    dict[1877046107] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionAcceptKey($0) }
    dict[-586814357] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionAbortKey($0) }
    dict[-332526693] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionCommitKey($0) }
    dict[-1473258141] = { return SecretApi101.DecryptedMessageAction.parse_decryptedMessageActionNoop($0) }
    dict[236446268] = { return SecretApi101.PhotoSize.parse_photoSizeEmpty($0) }
    dict[2009052699] = { return SecretApi101.PhotoSize.parse_photoSize($0) }
    dict[-374917894] = { return SecretApi101.PhotoSize.parse_photoCachedSize($0) }
    dict[2086234950] = { return SecretApi101.FileLocation.parse_fileLocationUnavailable($0) }
    dict[1406570614] = { return SecretApi101.FileLocation.parse_fileLocation($0) }
    dict[467867529] = { return SecretApi101.DecryptedMessageLayer.parse_decryptedMessageLayer($0) }
    dict[1930838368] = { return SecretApi101.DecryptedMessage.parse_decryptedMessageService($0) }
    dict[-1848883596] = { return SecretApi101.DecryptedMessage.parse_decryptedMessage($0) }
    dict[1815593308] = { return SecretApi101.DocumentAttribute.parse_documentAttributeImageSize($0) }
    dict[297109817] = { return SecretApi101.DocumentAttribute.parse_documentAttributeAnimated($0) }
    dict[358154344] = { return SecretApi101.DocumentAttribute.parse_documentAttributeFilename($0) }
    dict[978674434] = { return SecretApi101.DocumentAttribute.parse_documentAttributeSticker($0) }
    dict[-1739392570] = { return SecretApi101.DocumentAttribute.parse_documentAttributeAudio($0) }
    dict[250621158] = { return SecretApi101.DocumentAttribute.parse_documentAttributeVideo($0) }
    dict[-2044933984] = { return SecretApi101.InputStickerSet.parse_inputStickerSetShortName($0) }
    dict[-4838507] = { return SecretApi101.InputStickerSet.parse_inputStickerSetEmpty($0) }
    dict[-1148011883] = { return SecretApi101.MessageEntity.parse_messageEntityUnknown($0) }
    dict[-100378723] = { return SecretApi101.MessageEntity.parse_messageEntityMention($0) }
    dict[1868782349] = { return SecretApi101.MessageEntity.parse_messageEntityHashtag($0) }
    dict[1827637959] = { return SecretApi101.MessageEntity.parse_messageEntityBotCommand($0) }
    dict[1859134776] = { return SecretApi101.MessageEntity.parse_messageEntityUrl($0) }
    dict[1692693954] = { return SecretApi101.MessageEntity.parse_messageEntityEmail($0) }
    dict[-1117713463] = { return SecretApi101.MessageEntity.parse_messageEntityBold($0) }
    dict[-2106619040] = { return SecretApi101.MessageEntity.parse_messageEntityItalic($0) }
    dict[681706865] = { return SecretApi101.MessageEntity.parse_messageEntityCode($0) }
    dict[1938967520] = { return SecretApi101.MessageEntity.parse_messageEntityPre($0) }
    dict[1990644519] = { return SecretApi101.MessageEntity.parse_messageEntityTextUrl($0) }
    dict[-1672577397] = { return SecretApi101.MessageEntity.parse_messageEntityUnderline($0) }
    dict[-1090087980] = { return SecretApi101.MessageEntity.parse_messageEntityStrike($0) }
    dict[34469328] = { return SecretApi101.MessageEntity.parse_messageEntityBlockquote($0) }
    dict[144661578] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaEmpty($0) }
    dict[893913689] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaGeoPoint($0) }
    dict[1485441687] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaContact($0) }
    dict[1474341323] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaAudio($0) }
    dict[-90853155] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaExternalDocument($0) }
    dict[-235238024] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaPhoto($0) }
    dict[2063502050] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaDocument($0) }
    dict[-1760785394] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaVideo($0) }
    dict[-1978796689] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaVenue($0) }
    dict[-452652584] = { return SecretApi101.DecryptedMessageMedia.parse_decryptedMessageMediaWebPage($0) }
    return dict
}()
...
public struct SecretApi101 {
    public static func parse(_ buffer: Buffer) -> Any? {
        ...
        if let count = reader.readInt32() {
            ...
            while i < count {
                ...
                if let item = SecretApi101.parse(reader, signature: signature) as? T {
                    array.append(item)
                }
                else {
                    return nil
    ...
    public static func serializeObject(_ object: Any, buffer: Buffer, boxed: Swift.Bool) {
        switch object {
            case let _1 as SecretApi101.DecryptedMessageAction:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.PhotoSize:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.FileLocation:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.DecryptedMessageLayer:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.DecryptedMessage:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.DocumentAttribute:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.InputStickerSet:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.MessageEntity:
                _1.serialize(buffer, boxed)
            case let _1 as SecretApi101.DecryptedMessageMedia:
                _1.serialize(buffer, boxed)
            default:
                break
        }
    ...
    switch self {
        ...
        fileprivate static func parse_decryptedMessageActionSetMessageTTL(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionSetMessageTTL(ttlSeconds: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionReadMessages(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            if let _ = reader.readInt32() {
                _1 = SecretApi101.parseVector(reader, elementSignature: 570911930, elementType: Int64.self)
            }
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionReadMessages(randomIds: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionDeleteMessages(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionDeleteMessages(randomIds: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionScreenshotMessages(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionScreenshotMessages(randomIds: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionFlushHistory(_ reader: BufferReader) -> DecryptedMessageAction? {
            return SecretApi101.DecryptedMessageAction.decryptedMessageActionFlushHistory
        }
        fileprivate static func parse_decryptedMessageActionNotifyLayer(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionNotifyLayer(layer: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionResend(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionResend(startSeqNo: _1!, endSeqNo: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionRequestKey(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionRequestKey(exchangeId: _1!, gA: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionAcceptKey(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c3 = _3 != nil
            if _c1 && _c2 && _c3 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionAcceptKey(exchangeId: _1!, gB: _2!, keyFingerprint: _3!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionAbortKey(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionAbortKey(exchangeId: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionCommitKey(_ reader: BufferReader) -> DecryptedMessageAction? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.DecryptedMessageAction.decryptedMessageActionCommitKey(exchangeId: _1!, keyFingerprint: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageActionNoop(_ reader: BufferReader) -> DecryptedMessageAction? {
            return SecretApi101.DecryptedMessageAction.decryptedMessageActionNoop
        }
    ...
    public enum PhotoSize {
        ...
        case photoSize(type: String, location: SecretApi101.FileLocation, w: Int32, h: Int32, size: Int32)
        case photoCachedSize(type: String, location: SecretApi101.FileLocation, w: Int32, h: Int32, bytes: Buffer)
    ...
    switch self {
        ...
        fileprivate static func parse_photoSizeEmpty(_ reader: BufferReader) -> PhotoSize? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.PhotoSize.photoSizeEmpty(type: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_photoSize(_ reader: BufferReader) -> PhotoSize? {
            var _1: String?
            _1 = parseString(reader)
            var _2: SecretApi101.FileLocation?
            if let signature = reader.readInt32() {
                _2 = SecretApi101.parse(reader, signature: signature) as? SecretApi101.FileLocation
            }
            var _3: Int32?
            _3 = reader.readInt32()
            var _4: Int32?
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 {
                return SecretApi101.PhotoSize.photoSize(type: _1!, location: _2!, w: _3!, h: _4!, size: _5!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_photoCachedSize(_ reader: BufferReader) -> PhotoSize? {
            ...
            let _c5 = _5 != nil
            if _c1 && _c2 && _c3 && _c4 && _c5 {
                return SecretApi101.PhotoSize.photoCachedSize(type: _1!, location: _2!, w: _3!, h: _4!, bytes: _5!)
            }
            else {
                return nil
            }
    ...
    switch self {
        ...
        fileprivate static func parse_fileLocationUnavailable(_ reader: BufferReader) -> FileLocation? {
            ...
            let _c3 = _3 != nil
            if _c1 && _c2 && _c3 {
                return SecretApi101.FileLocation.fileLocationUnavailable(volumeId: _1!, localId: _2!, secret: _3!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_fileLocation(_ reader: BufferReader) -> FileLocation? {
            ...
            let _c4 = _4 != nil
            if _c1 && _c2 && _c3 && _c4 {
                return SecretApi101.FileLocation.fileLocation(dcId: _1!, volumeId: _2!, localId: _3!, secret: _4!)
            }
            else {
                return nil
            }
    ...
    public enum DecryptedMessageLayer {
        case decryptedMessageLayer(randomBytes: Buffer, layer: Int32, inSeqNo: Int32, outSeqNo: Int32, message: SecretApi101.DecryptedMessage)
    ...
    switch self {
        ...
        fileprivate static func parse_decryptedMessageLayer(_ reader: BufferReader) -> DecryptedMessageLayer? {
            ...
            var _4: Int32?
            _4 = reader.readInt32()
            var _5: SecretApi101.DecryptedMessage?
            if let signature = reader.readInt32() {
                _5 = SecretApi101.parse(reader, signature: signature) as? SecretApi101.DecryptedMessage
            }
            let _c1 = _1 != nil
            let _c2 = _2 != nil
            let _c3 = _3 != nil
            ...
            let _c5 = _5 != nil
            if _c1 && _c2 && _c3 && _c4 && _c5 {
                return SecretApi101.DecryptedMessageLayer.decryptedMessageLayer(randomBytes: _1!, layer: _2!, inSeqNo: _3!, outSeqNo: _4!, message: _5!)
            }
            else {
                return nil
            }
    ...
    public enum DecryptedMessage {
        case decryptedMessageService(randomId: Int64, action: SecretApi101.DecryptedMessageAction)
        case decryptedMessage(flags: Int32, randomId: Int64, ttl: Int32, message: String, media: SecretApi101.DecryptedMessageMedia?, entities: [SecretApi101.MessageEntity]?, viaBotName: String?, replyToRandomId: Int64?, groupedId: Int64?)
    ...
    switch self {
        ...
        fileprivate static func parse_decryptedMessageService(_ reader: BufferReader) -> DecryptedMessage? {
            var _1: Int64?
            _1 = reader.readInt64()
            var _2: SecretApi101.DecryptedMessageAction?
            if let signature = reader.readInt32() {
                _2 = SecretApi101.parse(reader, signature: signature) as? SecretApi101.DecryptedMessageAction
            }
            let _c1 = _1 != nil
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.DecryptedMessage.decryptedMessageService(randomId: _1!, action: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessage(_ reader: BufferReader) -> DecryptedMessage? {
            ...
            var _5: SecretApi101.DecryptedMessageMedia?
            if Int(_1!) & Int(1 << 9) != 0 {if let signature = reader.readInt32() {
                _5 = SecretApi101.parse(reader, signature: signature) as? SecretApi101.DecryptedMessageMedia
            } }
            var _6: [SecretApi101.MessageEntity]?
            if Int(_1!) & Int(1 << 7) != 0 {if let _ = reader.readInt32() {
                _6 = SecretApi101.parseVector(reader, elementSignature: 0, elementType: SecretApi101.MessageEntity.self)
            } }
            var _7: String?
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 && _c7 && _c8 && _c9 {
                return SecretApi101.DecryptedMessage.decryptedMessage(flags: _1!, randomId: _2!, ttl: _3!, message: _4!, media: _5, entities: _6, viaBotName: _7, replyToRandomId: _8, groupedId: _9)
            }
            else {
                return nil
            }
    ...
    public enum DocumentAttribute {
        ...
        case documentAttributeSticker(alt: String, stickerset: SecretApi101.InputStickerSet)
    ...
    switch self {
        ...
        fileprivate static func parse_documentAttributeImageSize(_ reader: BufferReader) -> DocumentAttribute? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.DocumentAttribute.documentAttributeImageSize(w: _1!, h: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_documentAttributeAnimated(_ reader: BufferReader) -> DocumentAttribute? {
            return SecretApi101.DocumentAttribute.documentAttributeAnimated
        }
        fileprivate static func parse_documentAttributeFilename(_ reader: BufferReader) -> DocumentAttribute? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DocumentAttribute.documentAttributeFilename(fileName: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_documentAttributeSticker(_ reader: BufferReader) -> DocumentAttribute? {
            var _1: String?
            _1 = parseString(reader)
            var _2: SecretApi101.InputStickerSet?
            if let signature = reader.readInt32() {
                _2 = SecretApi101.parse(reader, signature: signature) as? SecretApi101.InputStickerSet
            }
            let _c1 = _1 != nil
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.DocumentAttribute.documentAttributeSticker(alt: _1!, stickerset: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_documentAttributeAudio(_ reader: BufferReader) -> DocumentAttribute? {
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 {
                return SecretApi101.DocumentAttribute.documentAttributeAudio(flags: _1!, duration: _2!, title: _3, performer: _4, waveform: _5)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_documentAttributeVideo(_ reader: BufferReader) -> DocumentAttribute? {
            ...
            let _c4 = _4 != nil
            if _c1 && _c2 && _c3 && _c4 {
                return SecretApi101.DocumentAttribute.documentAttributeVideo(flags: _1!, duration: _2!, w: _3!, h: _4!)
            }
            else {
                return nil
            }
    ...
    switch self {
        ...
        fileprivate static func parse_inputStickerSetShortName(_ reader: BufferReader) -> InputStickerSet? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.InputStickerSet.inputStickerSetShortName(shortName: _1!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_inputStickerSetEmpty(_ reader: BufferReader) -> InputStickerSet? {
            return SecretApi101.InputStickerSet.inputStickerSetEmpty
        }
    ...
    switch self {
        ...
        fileprivate static func parse_messageEntityUnknown(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityUnknown(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityMention(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityMention(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityHashtag(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityHashtag(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityBotCommand(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityBotCommand(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityUrl(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityUrl(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityEmail(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityEmail(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityBold(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityBold(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityItalic(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityItalic(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityCode(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityCode(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityPre(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c3 = _3 != nil
            if _c1 && _c2 && _c3 {
                return SecretApi101.MessageEntity.messageEntityPre(offset: _1!, length: _2!, language: _3!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityTextUrl(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c3 = _3 != nil
            if _c1 && _c2 && _c3 {
                return SecretApi101.MessageEntity.messageEntityTextUrl(offset: _1!, length: _2!, url: _3!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityUnderline(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityUnderline(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityStrike(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityStrike(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_messageEntityBlockquote(_ reader: BufferReader) -> MessageEntity? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.MessageEntity.messageEntityBlockquote(offset: _1!, length: _2!)
            }
            else {
                return nil
            }
    ...
    public enum DecryptedMessageMedia {
        ...
        case decryptedMessageMediaExternalDocument(id: Int64, accessHash: Int64, date: Int32, mimeType: String, size: Int32, thumb: SecretApi101.PhotoSize, dcId: Int32, attributes: [SecretApi101.DocumentAttribute])
        ...
        case decryptedMessageMediaDocument(thumb: Buffer, thumbW: Int32, thumbH: Int32, mimeType: String, size: Int32, key: Buffer, iv: Buffer, attributes: [SecretApi101.DocumentAttribute], caption: String)
    ...
    switch self {
        ...
        fileprivate static func parse_decryptedMessageMediaEmpty(_ reader: BufferReader) -> DecryptedMessageMedia? {
            return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaEmpty
        }
        fileprivate static func parse_decryptedMessageMediaGeoPoint(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            let _c2 = _2 != nil
            if _c1 && _c2 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaGeoPoint(lat: _1!, long: _2!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaContact(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            let _c4 = _4 != nil
            if _c1 && _c2 && _c3 && _c4 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaContact(phoneNumber: _1!, firstName: _2!, lastName: _3!, userId: _4!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaAudio(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            let _c5 = _5 != nil
            if _c1 && _c2 && _c3 && _c4 && _c5 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaAudio(duration: _1!, mimeType: _2!, size: _3!, key: _4!, iv: _5!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaExternalDocument(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            var _5: Int32?
            _5 = reader.readInt32()
            var _6: SecretApi101.PhotoSize?
            if let signature = reader.readInt32() {
                _6 = SecretApi101.parse(reader, signature: signature) as? SecretApi101.PhotoSize
            }
            var _7: Int32?
            _7 = reader.readInt32()
            var _8: [SecretApi101.DocumentAttribute]?
            if let _ = reader.readInt32() {
                _8 = SecretApi101.parseVector(reader, elementSignature: 0, elementType: SecretApi101.DocumentAttribute.self)
            }
            let _c1 = _1 != nil
            let _c2 = _2 != nil
            let _c3 = _3 != nil
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 && _c7 && _c8 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaExternalDocument(id: _1!, accessHash: _2!, date: _3!, mimeType: _4!, size: _5!, thumb: _6!, dcId: _7!, attributes: _8!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaPhoto(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            let _c9 = _9 != nil
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 && _c7 && _c8 && _c9 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaPhoto(thumb: _1!, thumbW: _2!, thumbH: _3!, w: _4!, h: _5!, size: _6!, key: _7!, iv: _8!, caption: _9!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaDocument(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            let _c9 = _9 != nil
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 && _c7 && _c8 && _c9 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaDocument(thumb: _1!, thumbW: _2!, thumbH: _3!, mimeType: _4!, size: _5!, key: _6!, iv: _7!, attributes: _8!, caption: _9!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaVideo(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 && _c7 && _c8 && _c9 && _c10 && _c11 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaVideo(thumb: _1!, thumbW: _2!, thumbH: _3!, duration: _4!, mimeType: _5!, w: _6!, h: _7!, size: _8!, key: _9!, iv: _10!, caption: _11!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaVenue(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            if _c1 && _c2 && _c3 && _c4 && _c5 && _c6 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaVenue(lat: _1!, long: _2!, title: _3!, address: _4!, provider: _5!, venueId: _6!)
            }
            else {
                return nil
            }
        ...
        fileprivate static func parse_decryptedMessageMediaWebPage(_ reader: BufferReader) -> DecryptedMessageMedia? {
            ...
            let _c1 = _1 != nil
            if _c1 {
                return SecretApi101.DecryptedMessageMedia.decryptedMessageMediaWebPage(url: _1!)
            }
            else {
                return nil
            }
